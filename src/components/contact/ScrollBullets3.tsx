...
const sections = [
  ...
  { id: "contact-info", label: "Headquaters" },
  { id: "get-in-touch", label: "Get In Touch" },
  { id: "offices", label: "Contact Info" },
];

export default function ScrollBullets3() {
  ...
  useEffect(() => {
    // Observe the hero section to hide bullets initially
