...
function HeaderP2Inner({ title, category }: ProjectHeaderProps2) {
...
export default function HeaderP2({ title, category }: ProjectHeaderProps2) {
  return (
    <Suspense fallback={null}>
      <HeaderP2Inner title={title} category={category} />
    </Suspense>
  );
}
