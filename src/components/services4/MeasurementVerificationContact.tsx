      ...
      <Grid templateColumns={{ base: "1fr", md: "40% 60%" }} gap={12}>
        ...
        >
          <Heading
            ...
            mb={6}
          >
            Measurement & Verification (M&V) Contact
          </Heading>

          <Text fontSize="md" color="gray.700" mb={4}>
            For inquiries related to Measurement & Verification (M&V) services,
            energy savings validation, or compliance with energy performance
            standards, please reach out to MyCES using the contact details
            below.
          </Text>

          <Text fontSize="md" color="gray.700" mb={6}>
            Our M&V specialists support organizations in validating energy
            savings, normalizing operational data, and ensuring compliance with
            IPMVP and ISO 50001 requirements.
          </Text>
        ...
        >
          <form onSubmit={handleSubmit}>
            <Stack gap={6}>
              ...
              {/* MESSAGE */}
              <Textarea
                placeholder="Describe your Measurement & Verification requirements, project scope, or energy performance concerns"
                value={message}
