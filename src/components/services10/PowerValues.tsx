  ...
  const sections = [
    {
      ...
      content: [
        "To be a leading provider of innovative and sustainable building electrical and control system solutions in Malaysia, trusted for quality, reliability, and professionalism.",
      ],
    ...
    },
    {
      ...
      content: [
        "Deliver high-quality electrical, wiring, and building control system solutions",
        "Provide clients reliable services through skilled professionals, advanced technology, and continuous improvement",
        "Build long-term partnerships based on trust, integrity, and customer satisfaction",
      ],
    ...
    },
    {
      ...
      content: [
        "Integrity, Innovation, Sustainability, Excellence, Safety, Customer Focus",
      ],
    ...
    },
    {
      ...
      content: [
        "Expand expertise in Building Automation Systems across Malaysia",
        "Enhance technical capabilities via training and certifications",
        "Strengthen reputation as a trusted partner for government, corporate, and industrial projects",
        "Contribute to smarter, safer, and greener buildings",
      ],
  ...
  return (
    ...
    >
      ...
      <Flex justify="flex-end" mt={10} mr="5%">
        <Link href="/businessPower/power" passHref>
          <Button
            bg="white"
            color={companyGreen}
            border="1px solid"
