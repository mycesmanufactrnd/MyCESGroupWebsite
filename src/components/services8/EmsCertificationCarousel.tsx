...
const features = [
  { title: "Strategic Policy & Objectives", description: "Establishing clear energy policies and measurable goals that align with organizational targets to provide a roadmap for efficiency." },
  { title: "Comprehensive Resource Monitoring", description: "Continuous tracking of all energy streams, including electricity, gas, and fuel, to understand the total energy footprint of the facility." },
  { title: "IoT Data Collection", description: "Utilizing advanced meters and sensors to gather precise, real-time data, ensuring that management decisions are based on accurate consumption facts." },
  { title: "Performance Analytics", description: "In-depth analysis of collected data to identify trends, benchmark performance, and pinpoint specific areas where energy is being wasted." },
  { title: "Efficiency Action Plans", description: "Developing and executing targeted technical and behavioral strategies designed to improve energy performance and hit reduction targets." },
];
