...
export default function ReemconsultancyFeature() {
  return (
    <Box
      w="full"
        ...
        >
          ...
          <Box>
            ...
            <Text
              ...
              lineHeight="1.9"
            >
              Helps organizations monitor and optimize electrical energy use.
              The consultant identifies energy wastage and implements efficiency
