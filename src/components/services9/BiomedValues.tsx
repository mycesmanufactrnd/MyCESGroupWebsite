  ...
  const sections = [
    {
      ...
      content: [
        "To be the benchmark of excellence in Biomedical Engineering",
        "Providing world-class solutions that exceed client expectations",
        "Advancing healthcare standards through innovative approaches",
      ],
    ...
    },
    {
      ...
      content: [
        "Deliver high-quality Biomedical Engineering services with reliability and innovation",
        "Build long-term client relationships with cutting-edge, tailored solutions",
        "Contribute to a more efficient and sustainable healthcare industry",
      ],
    ...
    },
    {
      ...
      content: [
        "Customer Commitment: Understand and meet client needs",
        "Innovation-Driven Excellence: Foster creativity and forward-thinking",
        "Integrity and Professionalism: Maintain ethical principles and high professional standards",
      ],
  ...
  return (
    ...
    >
      ...
      <Flex justify="flex-end" mt={10} mr="5%">
        <Link href="/businessBiomed/biomed" passHref>
          <Button
            bg="white"
            color={companyGreen}
            border="1px solid"
